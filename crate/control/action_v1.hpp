...
public:
   ...
   //! \param id The id of the the node containing the action
   //! \param action_id The id of the action
   //! \param value The value for the action
   action_v1_c(int64_t timestamp, 
                     std::string id, 
   ...
   //! \brief Decode action_v1_c object from a json string
   ...
   //! \brief Decode action_v1_c object from a json object
